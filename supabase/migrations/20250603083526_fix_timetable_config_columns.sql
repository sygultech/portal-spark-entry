-- Drop the existing functions first to avoid dependency issues
...
-- Update the save_timetable_configuration function to use correct column names
...
-- Update the get_timetable_configuration function to use correct column names
...
-- Update the get_timetable_configurations function to use correct column names
