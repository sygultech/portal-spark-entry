...
-- Create the function with first_name and last_name support
...
BEGIN
    ...
    END IF;
    IF p_data->>'first_name' IS NULL OR p_data->>'first_name' = '' THEN
        RAISE EXCEPTION 'First name is required';
    END IF;
    IF p_data->>'last_name' IS NULL OR p_data->>'last_name' = '' THEN
